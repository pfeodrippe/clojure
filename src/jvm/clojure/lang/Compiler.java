		...
		public Expr parse(C context, Object frm) {
			...
			if(maybeField)    //field
				...
				if(c != null)
                    ...
                    return new InstanceMethodExpr(source, line, column, tag, instance, null, munge(sym.name), args,
...
static class QualifiedMethodExpr implements Expr {
	...
	public QualifiedMethodExpr(Class methodClass, Symbol sym, IPersistentVector coord) {
		this(methodClass, sym, null, coord);
	}

	public QualifiedMethodExpr(Class methodClass, Symbol sym, StaticFieldExpr fieldOL, IPersistentVector coord) {
		c = methodClass;
		methodSymbol = sym;
...
static class InstanceMethodExpr extends MethodExpr{
	...
	public InstanceMethodExpr(String source, int line, int column, Symbol tag, Expr target,
        Class qualifyingClass, String methodName, java.lang.reflect.Method resolvedMethod, IPersistentVector args, boolean tailPosition, IPersistentVector coord)
	...
	public InstanceMethodExpr(String source, int line, int column, Symbol tag, Expr target,
		Class qualifyingClass, String methodName, IPersistentVector args, boolean tailPosition, IPersistentVector coord)
...
static class StaticMethodExpr extends MethodExpr{
	...
	public StaticMethodExpr(String source, int line, int column, Symbol tag, Class c,
        String methodName, java.lang.reflect.Method preferredMethod, IPersistentVector args, boolean tailPosition, IPersistentVector coord)
	{
...
//			fexpr = new ConstantExpr(new KeywordCallSite(((KeywordExpr)fexpr).k));
		...
		if(fexpr instanceof QualifiedMethodExpr)
		{
			...
			return toHostExpr(qmexpr, (String) SOURCE.deref(), lineDeref(), columnDeref(), tagOf(form), tailPosition, args, coord);
		}
			...
			switch(qmexpr.kind) {
				...
				default:
					return new StaticMethodExpr(source, line, column, tag, qmexpr.c,
                        munge(qmexpr.methodName), (java.lang.reflect.Method) method, args, tailPosition, coord);
			}
		}
		else {
			switch(qmexpr.kind) {
				...
				default:
					return new StaticMethodExpr(source, line, column, tag, qmexpr.c,
                        munge(qmexpr.methodName), args, tailPosition, coord);
			}
		}
	}
}
